...
var HELP_ = [
  ...
  '',
  '--timeout <millisec>',
  '  A timeout in milliseconds, defaults to 1000ms. Prevents hanging in',
  '  presence of "stuck" tabs, e.g. a tab in the "Aw, snap!" state.',
  '',
  '-n|-no-trailing-eol',
  ...
  '  "all" means "all windows"; "window" means "current window";',
  '  if IDs are used, they must be comma-separated. Note that for --list-tabs,',
  '  this argument is optional and defaults to "all".',
  '',
  'MORE_OPTIONS:',
  '',
  '--all-frames',
