  ...
  argsPromise.then(function(freeArgs) {
    ...
    if (help ||
      ...
      cx.stdout.write([
        ...
        '  a quick identification. For a more involved querying and',
        '  a detailed list of tab properties, use the form',
        '  `chrome --call-api tabs.query {OPTIONS}`.',
        '',
        ...
        '   replaced by the value read from the stdin (e.g. when piped in from',
        '   another command).',
