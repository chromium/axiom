...
/**
  ...
  */
var FindBuiltinOrExecutableResult;
...
/**
  ...
  *
  * @param {!string} pathSpec
  * @return {!Promise<FindBuiltinOrExecutableResult>}
  */
Wash.prototype.findBuiltinOrExecutable = function(pathSpec) {
   ...
   */
  var findBuiltin = function(path) {
    return this.builtinsFS.stat(path).then(function(statResult) {
      return statResult;
  ...
  return findBuiltin(builtinPath).then(function(statResult) {
    if (statResult) {
      return Promise.resolve({
      ...
      return this.findExecutable(pathSpec).then(function(result) {
        return Promise.resolve({
          fileSystem: this.fileSystemManager,
          statResult: result.statResult,
          path: result.path
        });
      }.bind(this));
    }
