...
export var main = function(executeContext) {
  ...
  // TODO(rpaquay): Not sure I understand "getWhitespace" intended usage.
  var x = {getWhitespace: {}};
  fileSystems.forEach(function(fileSystem) {
    var spaces = getWhitespace.call(x, maxLength - fileSystem.rootPath.spec.length + 3);
    rv += fileSystem.rootPath.spec + spaces + '"' + fileSystem.description + '"' + '\n';
  });
