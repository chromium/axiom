...
var Readline = function(executeContext) {
  ...
  this.executeContext.stdinStream.onData.addListener(this.onStdIn_, this);
...
Readline.prototype.onStdIn_ = function() {
  var value = this.executeContext.stdinStream.consume();
