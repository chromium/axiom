...
ImportCommand.prototype.traverseFiles_ = function(fileEntry, pathString){
  ...
  if (fileEntry.isFile) {
    ...
    var directoryPath = pathString + '/' + fileEntry.name;
      var path = Path.abs(this.destination.spec, directoryPath);
      this.fsm_.mkdir(path);
    ...
    dirReader.readEntries(function(entries) {
      ...
      fileCompleter.resolve(directoryPath);
    }.bind(this));
  } 
...
ImportCommand.prototype.handleUnresponsiveInput_ = function(evt) {
  ...
  this.dummyFocusInput_.removeEventListener('blur',
      this.handleUnresponsiveInput_, false);
}
