...
ImportCommand.prototype.handleFileSelect_ = function(evt) {
  console.log('handleFileSelect_' + this.dummyFocusInput_ + this.dummyFocusInput_.onfocus);
  this.dummyFocusInput_.removeEventListener('focus', this.handleFileCancel_, false);
  console.log('handleFileSelect_' + this.dummyFocusInput_ + this.dummyFocusInput_.onfocus);
