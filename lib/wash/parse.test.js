...
describe('wash/parse', function () {
  ...
  it('should fail on malformed arrays', function() {
    var list = [
      '--ary [a,',
      '--ary [a, ,b]',
      '--ary [a, b] ]',
    ...
    for (var i = 0; i < list.length; i++) {
      var p = new Parse(list[i]);
      try {
        var args = p.parseArgs({ 'ary': '@' });
        expect(list[i]).toBe('fail');
      } catch (ex) {
        expect(ex.errorName).toBe('Parse');
      }
    }
  ...
  xit('should parse object args', function() {
  ...
  it('should fail on malformed objects', function() {
    var list = [
      '--obj {b: ',
      '--obj {a b}',
      '--obj {a: b} }',
  ...
  xit('should handle value args', function() {
  ...
  xit('should handle complex args', function() {
