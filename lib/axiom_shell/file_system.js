...
ShellFS.prototype.mountDomfs = function() {
  ...
  navigator.webkitPersistentStorage.requestQuota(capacity, function(grantedBytes) {
    requestFs(window.PERSISTENT, grantedBytes, onFileSystemFound,
        onFileSystemError);
  });
};
