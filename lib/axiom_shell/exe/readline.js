...
export var Readline = function(executeContext) {
  ...
  if (inputHistory && !(inputHistory instanceof Array)) {
    this.executeContext.closeError('Invalid',
  ...
  this.onComplete = new AxiomEvent(this.onComplete_.bind(this));
...
export var main = function(executeContext) {
  if (typeof executeContext.arg != 'object') {
    return executeContext.closeError('TypeMismatch', ['argv', 'object']);
  }
...
Readline.prototype.commands['accept-line'] = function() {
  ...
  this.print('\r\n');
  this.onComplete.fire(this.line);
};
...
Readline.prototype.onComplete_ = function() {
