...
/**
 * The returned meta-event will fire as soon as (with opt_fireOnce) or whenever
 * (with opt_fireOnce off) one of the sub-events fire.
 *
...
/**
 * The returned meta-event will fire as soon as all of the sub-events have fired
 * at least once. After that, the process either stops (with opt_fireOnce on)
 * or resets (with opt_fireOnce on).
 * 
 * @param {!Array<!AxiomEvent>} events
 * @param {boolean=} opt_fireOnce
 * @return {!AxiomEvent}
