...
Ephemeral.prototype.reset = function() {
  ...
  this.ephemeralPromise.then(
    function(resolveValue) {
      ...
      this.onClose.fire(resolveValue);
    }.bind(this),
    function(rejectValue) {
      if (this.ephemeralPromise != ephemeralPromise)
        return;

      var wasReady = (this.readyState == Ephemeral.State.Ready);
...
Ephemeral.prototype.dependsOn = function(otherEphemeral) {
  otherEphemeral.onClose.addListener(
    function() {
      ...
      this.closeError('ParentClosed', [otherEphemeral.closeReason,
 ...
 * @param {*} value
 */
Ephemeral.prototype.closeErrorValue = function(value) {
 ...
 * @param {Array<*>} arg
 */
Ephemeral.prototype.closeError = function(name, arg) {
