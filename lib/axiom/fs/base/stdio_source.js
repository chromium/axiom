...
export var StdioSource = function() {
  ...
  this.stdin = this.stdinBuffer_.createWritableStream();
  /** @const @type {!ReadableStream} */
  this.stdout = this.stdoutBuffer_.createReadableStream();
  /** @const @type {!ReadableStream} */
  this.stderr = this.stderrBuffer_.createReadableStream();

  /** @const @type {!Stdio} */
  this.stdio = new Stdio(
    this.stdinBuffer_.createReadableStream(), 
    this.stdoutBuffer_.createWritableStream(),
    this.stderrBuffer_.createWritableStream());
};
