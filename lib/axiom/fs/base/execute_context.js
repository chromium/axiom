 ...
 *
 * @param {!FileSystemManager} fileSystemManager The parent file system.
 * @param {Path} path
 * @param {*} arg
 */
export var ExecuteContext = function(fileSystemManager, path, arg) {
  Ephemeral.call(this);
  ...
  this.dependsOn(this.fileSystemManager);
