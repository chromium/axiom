...
ExecuteContext.prototype.setCallee = function(executeContext) {
  ...
  var onClose = function() {
    this.callee.stdoutStream.onData.removeListener(this.stdout, this);
    this.callee.stderrStream.onData.removeListener(this.stderr, this);
  ...
  this.callee.stdoutStream.onData.addListener(this.stdout, this);
  this.callee.stderrStream.onData.addListener(this.stderr, this);
