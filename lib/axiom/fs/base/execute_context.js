...
import WritableEventStream from 'axiom/fs/stream/writable_event_stream';
 ...
 * @param {*} arg
 */
export var ExecuteContext = function(fileSystem, path, arg) {
  Ephemeral.call(this);
  ...
  /** @type {!WritableEventStream} */
  this.stdoutStream = new WritableEventStream();
  /** @type {!WritableEventStream} */
  this.stderrStream = new WritableEventStream();
  /** @type {!ReadableEventStream} */
  this.stdinStream = new ReadableEventStream();
  /** @type {!AxiomEvent} */
...
ExecuteContext.prototype.setCallee = function(executeContext) {
  ...
  var onClose = function() {
    this.callee.stdoutStream.onData.removeListener(this.forwardStdout, this);
    this.callee.stderrStream.onData.removeListener(this.forwardStderr, this);
  ...
  this.callee.stdoutStream.onData.addListener(this.forwardStdout, this);
  this.callee.stderrStream.onData.addListener(this.forwardStderr, this);
...
ExecuteContext.prototype.stdout = function(value, opt_onAck) {
  ...
  this.stdoutStream.write(value, opt_onAck);
};
...
ExecuteContext.prototype.stderr = function(value, opt_onAck) {
  ...
  this.stderrStream.write(value, opt_onAck);
};

/**
 * @param {*} value
 * @param {function()=} opt_onAck
 * @return {void}
 */
ExecuteContext.prototype.forwardStdout = function(value, opt_onAck) {
  this.stdoutStream.write(value, opt_onAck);
}
 ...
 * @return {void}
 */
ExecuteContext.prototype.forwardStderr = function(value, opt_onAck) {
  this.stderrStream.write(value, opt_onAck);
}

/**
 * Send data to stdin of this executable (or callee).
 *
 * This is not restricted to string values.  Recipients should filter out
 ...
 * @return {void}
 */
ExecuteContext.prototype.stdin = function(value, opt_onAck) {
  this.assertReady();
  if (this.callee) {
    this.callee.stdin(value, opt_onAck);
  } else {
    this.stdinStream.push(value, opt_onAck);
  }
};
