 ...
 * @return {void}
 */
ExecuteContext.prototype.addCallee = function(callee) {
 ...
 * addCallee) from it, and will be overwritten the next time the authoritative
 * state changes.
 *
