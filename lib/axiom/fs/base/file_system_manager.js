...
export var FileSystemManager = function() {
   ...
   * @private @type {Object<string, FileSystem>}
   */
  this.fileSystems_ = {};
};
...
FileSystemManager.prototype.getFileSystem_ = function(path) {
  if (!this.fileSystems_.hasOwnProperty(path.fileSystemName)) {
    throw new AxiomError.NotFound('filesystem-name', path.fileSystemName);
  }

  return this.fileSystems_[path.fileSystemName];
}
