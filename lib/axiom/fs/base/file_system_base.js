 ...
 */
export var FileSystemBase = function() {
  Ephemeral.call(this);
};

export default FileSystemBase;

FileSystemBase.prototype = Object.create(Ephemeral.prototype);
 ...
 */
FileSystemBase.prototype.alias = function(pathFrom, pathTo) {
  abstract();
};
 ...
 */
FileSystemBase.prototype.createExecuteContext = function(path, stdio, arg) {
  abstract();
};
 ...
 */
FileSystemBase.prototype.createOpenContext = function(path, mode) {
  abstract();
};
 ...
 */
FileSystemBase.prototype.list = function(path) {
  abstract();
};
 ...
 * @return {!Promise<undefined>}
 */
FileSystemBase.prototype.mkdir = function(path) {
  abstract();
};
 ...
 * @return {!Promise<undefined>}
 */
FileSystemBase.prototype.move = function(fromPath, toPath) {
  abstract();
};
 ...
 */
FileSystemBase.prototype.stat = function(path) {
  abstract();
};
 ...
 * @return {Promise}
 */
FileSystemBase.prototype.unlink = function(path) {
  abstract();
};
 ...
 */
FileSystemBase.prototype.readFile = function(
 ...
 */
FileSystemBase.prototype.writeFile = function(
 ...
 * @return {void}
 */
FileSystemBase.prototype.install = function(obj) {
  abstract();
};
