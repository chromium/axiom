...
describe('Path', function () {
  ...
  it('should allow Windows drive letters', function () {
    var p = new Path('fs:/c:');
    expect(p.spec).toEqual('fs:/c:');
  });

  it('should allow Windows drive letters only', function () {
    var p = new Path('fs:c:');
    expect(p.spec).toEqual('fs:/c:');
  });

  it('should allow Windows paths starting with a drive letter', function () {
    var p = new Path('fs:c:/foo/bar.txt');
    expect(p.spec).toEqual('fs:/c:/foo/bar.txt');
  });

  it('should convert Windows path separators', function () {
    var p = new Path('fs:\\c:\\foo\\bar.txt');
    expect(p.spec).toEqual('fs:/c:/foo/bar.txt');
  });
});
