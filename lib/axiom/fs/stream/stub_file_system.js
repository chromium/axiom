 ...
 * @return {void}
 */
StubFileSystem.prototype.onRequest_ = function(subject, request) {
 ...
 * @return {Promise}
 */
StubFileSystem.prototype['writable-stream.write'] = function(request) {
 ...
 * @return {Promise}
 */
StubFileSystem.prototype['readable-stream.pause'] = function(request) {
  var streamId = request.streamId;
 ...
 * @return {Promise}
 */
StubFileSystem.prototype['readable-stream.resume'] = function(request) {
  var streamId = request.streamId;
  var stream = this.readableStreams_[streamId];
  if (!stream) {
    return Promise.reject(
 ...
 * @return {Promise}
 */
StubFileSystem.prototype['readable-stream.read'] = function(request) {
  var streamId = request.streamId;
  var stream = this.readableStreams_[streamId];
  if (!stream) {
    return Promise.reject(
