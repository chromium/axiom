 ...
 */
export var ReadableMemoryStream = function(buffer, opt_name) {
  AxiomStream.call(this, 'ReadableMemoryStream ' +
  ...
  this.buffer_.onFlush.listenOnce(function() {
    this.end();
  }.bind(this));
};
 ...
 * @return {void}
 */
ReadableMemoryStream.prototype.end = function() {
  this.assertOpen();
  this.onEnd.fire();
};
