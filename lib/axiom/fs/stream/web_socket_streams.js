...
WebSocketStreams.prototype.open = function(url) {
  GenericStreams.prototype.open.call(this).then(function() {
...
WebSocketStreams.prototype.close = function() {
  ...
  this.webSocket = null;
  GenericStreams.prototype.close.call(this);
};
 ...
 */
 WebSocketStreams.prototype.handleSend_ = function(item) {
  ...
  GenericStreams.prototype.handleSend_.call(this);
