...
WebSocketStreams.prototype = Object.create(BufferedStreams.prototype);
 ...
 * @return {void}
 */
WebSocketStreams.prototype.closeSocket_ = function() {
  if (!this.webSocket)
    return;
...
WebSocketStreams.prototype.getState_ = function() {
  switch(this.webSocket.readyState) {
    case 0:
      return BufferedStreams.ConnectionState.CONNECTING;
    case 1:
      return BufferedStreams.ConnectionState.CONNECTED;
    case 2:
      return BufferedStreams.ConnectionState.CLOSING;
    case 3:
