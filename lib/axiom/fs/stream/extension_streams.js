...
ExtensionStreams.prototype.openExtension = function(appId) {
  ...
  return PostMessageStreams.prototype.open.call(this, {port: port, alreadyConnected: false});
};
...
ExtensionStreams.prototype.listenAsExtension = function() {
  return new Promise(function(resolve, reject) {
    chrome.runtime.onConnectExternal.addListener(function(port) {
      PostMessageStreams.prototype.open.call(this, {port: port, alreadyConnected: false});
