...
/**
 * Emitted when `end()` is called, after all events have been processed by
 * the ReadableStream consumer.
 * @type {!AxiomEvent}
 */
StreamsSource.prototype.onEnd;

/**
 * Emitted at the same time as `onEnd`.
 *
 * @type {!AxiomEvent}
 */
StreamsSource.prototype.onFinish;
 ...
 * @return {void}
 */
StreamsSource.prototype.end = function() {};

/**
 * @param {*} error
 * @return {void}
 */
StreamsSource.prototype.close = function(error) {};
