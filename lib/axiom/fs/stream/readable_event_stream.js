...
/**
 * Set (or clear) the callback to invoke then data is available in the stream.
 *
 * @param {?DataCallback} callback
 * @return {*}
 */
ReadableEventStream.prototype.onData = function(callback) {
 ...
 * @return {*}
 */
ReadableEventStream.prototype.read = function() {
 ...
 * @return {void}
 */
ReadableEventStream.prototype.flushEvents_ = function() {
  while (true) {
    if (!this.onDataCallback_)
      break;
