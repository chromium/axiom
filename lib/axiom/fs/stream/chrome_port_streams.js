...
ChromePortStreams.prototype.setPort = function(port, alreadyConnected) {
  ...
  if (alreadyConnected) {
    ...
    port.onDisconnect.addListener(this.onConnectionError_);
 ...
 * @return {void}
 */
ChromePortStreams.prototype.onConnectedMessage_ = function(event) {
 ...
 * @return {void}
 */
ChromePortStreams.prototype.onConnectionError_ = function(event) {
...
ChromePortStreams.prototype.cleanupConnectionListeners_ = function() {
  this.port_.onMessage.removeListener(this.onConnectedMessage_);
  this.port_.onDisconnect.removeListener(this.onConnectionError_);
};
