...
export var WritableStreamForwarder = function(stream) {
  ...
  this.stream.onFinish.addListener(this.onFinishCallback_, this);
};
 ...
 * @return {void}
 */
WritableStreamForwarder.prototype.onFinishCallback_ = function() {
  this.ended_ = true;
  this.onFinish.fire();
};
...
WritableStreamForwarder.prototype.end = function() {
  this.stream.onFinish.removeListener(this.onFinishCallback_, this);
 ...
 * @return {void}
 */
WritableStreamForwarder.prototype.close = function(error) {
  this.stream.onFinish.removeListener(this.onFinishCallback_, this);
};
