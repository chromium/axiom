 ...
 */
export var ReadableFileStreamBuffer = function(execCx, filePath, openMode) {
  StreamBuffer.call(this);

  /** @const @type {!ReadableStream} */
  this.readableStream = new ReadableMemoryStream(this);

  execCx.fileSystemManager.readFile(filePath, DataType.ArrayBuffer, openMode)
...
ReadableFileStreamBuffer.prototype.close = function() {
