 ...
 */
export var MemoryStreamBuffer = function(opt_name) {
  StreamBuffer.call(this, 'MemoryStreamBuffer ' + (opt_name || '<unnamed>'));

  /** @const @type {!ReadableStream} */
  this.readableStream = new ReadableMemoryStream(this, 'out');
  /** @const @type {!WritableStream} */
  this.writableStream = new WritableMemoryStream(this, 'in');

  this.writableStream.onFinish.listenOnce(function() {
    // This will fire an event chain onFlush -> this.readableStream.onEnd.
