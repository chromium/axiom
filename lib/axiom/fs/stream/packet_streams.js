 ...
 * @param {string} source
 */
export var PacketStreams = function(source) {
  /** @type {*} */
  this.source = source;
  /** @type {!AxiomEvent} */
...
export default PacketStreams;

/**
 * @param {string} appId
 * @return {Promise}
 */
 PacketStreams.prototype.open = function(appId) {
  /*%*/ console.log("open!" + appId); /*%*/
  this.appId = appId;
  
  return new Promise(function(resolve, reject) {
    chrome.runtime.sendMessage(appId, {openUrlInEditor: "url"},
        function(response) {
          resolve();
        });
  });
 ...
 * @return {void}
 */
 PacketStreams.prototype.close = function() {
  /*%*/ console.log("close!"); /*%*/
  //TODO: Implement
};
 ...
 * @return {void}
 */
 PacketStreams.prototype.pause = function() {
  /*%*/ console.log("pause!"); /*%*/
  this.paused_ = true;
};
 ...
 * @return {void}
 */
 PacketStreams.prototype.resume = function() {
  /*%*/ console.log("resume!"); /*%*/
  this.paused_ = false;
};
 ...
 * @return {*}
 */
 PacketStreams.prototype.read = function() {
  /*%*/ console.log("read!"); /*%*/
  return this.read_();
};
 ...
 * @return {void}
 */
 PacketStreams.prototype.write = function(value, opt_callback) {
 ...
 * @return {void}
 */
 PacketStreams.prototype.onStreamError_ = function(error) {
 ...
 * @return {void}
 */
 PacketStreams.prototype.onExtensionMessage_ = function(event) {
 ...
 * @return {void}
 */
 PacketStreams.prototype.flushReadQueue_ = function() {
  while (!this.paused_) {
    var item = this.read_();
    if (!item)
      break;
 ...
 * @return {*}
 */
 PacketStreams.prototype.read_ = function() {
