 ...
 *
 * @constructor @implements {StreamsSource}
 * @param {*} nodeWebSocket
 */
export var NodeWebSocketStreams = function() {
  /** @type {WebSocket} */
  this.webSocket = null;
 ...
 * @return {Promise}
 */
NodeWebSocketStreams.prototype.open = function(url) {
 ...
 * @return {void}
 */
NodeWebSocketStreams.prototype.onOpen_ = function() {
  this.flushWriteQueue_();
};
 ...
 * @return {void}
 */
NodeWebSocketStreams.prototype.onClose_ = function() {
};

/**
 * @return {void}
 */
NodeWebSocketStreams.prototype.onError_ = function() {
};

/**
 * @return {void}
 */
NodeWebSocketStreams.prototype.onMessage_ = function(event) {
  var data = event.data;
