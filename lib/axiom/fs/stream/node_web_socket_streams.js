...
export var NodeWebSocketStreams = function(webSocket) {
  ...
  this.webSocket.on('message', this.onSocketMessage_);
  this.webSocket.on('close', this.onSocketClose_);
};
 ...
 * @return {void}
 */
NodeWebSocketStreams.prototype.closeSocket_ = function() {
  this.webSocket.removeListener('message', this.onSocketMessage_);
  this.webSocket.removeListener('close', this.onSocketClose_);
...
NodeWebSocketStreams.prototype.onSocketClose_ = function() {
  ...
  // TODO(rpaquay): Check it is ok to call `closeSocket` here.
  this.closeSocket_();
};
