...
export var NodeWebSocketStreams = function(webSocket) {
  ...
  this.webSocket_.on('message', this.onSocketMessage_.bind(this));
  this.webSocket_.on('close', this.onSocketClose_.bind(this));
  this.webSocket_.on('error', this.onSocketError_.bind(this));
};
