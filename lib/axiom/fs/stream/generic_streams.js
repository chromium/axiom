 ...
 * @return {Promise}
 */
GenericStreams.prototype.open = function() {
  /*%*/ console.log("open!"); /*%*/
 ...
 * @return {void}
 */
GenericStreams.prototype.close = function() {
  /*%*/ console.log("close!"); /*%*/
};
 ...
 * @return {void}
 */
GenericStreams.prototype.handleConnected_ = function(event) {
  this.flushWriteQueue_();
}
 ...
 * @return {void}
 */
GenericStreams.prototype.handleClose_ = function(event) {
  this.onClose.fire();
}
