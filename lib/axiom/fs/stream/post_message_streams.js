...
PostMessageStreams.prototype.open = function(window) {
  ...
  window.onMessage.addListener(this.onConnectedMessage_, false);
...
PostMessageStreams.prototype.write = function(value, opt_callback) {
  ...
  window.postMessage(/* TODO fix */ value)
};
...
PostMessageStreams.prototype.onConnectedMessage_ = function(event) {
  console.log(event);
  window.onMessage.removeListener(this.onConnectedMessage_, false);
