...
PostMessageStreams.prototype.onConnectionError_ = function(event) {
  this.connectionState_ = BufferedStreams.ConnectionState.CLOSED;
  this.cleanupConnectionListeners_();
  this.completer_.reject(
      new AxiomError.Runtime('Error connecting to extension'));
  this.port = null;
};
...
PostMessageStreams.prototype.handleConnected_ = function() {
  ...
  this.port.onDisconnect.addListener(this.onDisconnect_);
...
PostMessageStreams.prototype.handleClose_ = function() {
  ...
  this.port.onDisconnect.removeListener(this.onDisconnect_);
...
PostMessageStreams.prototype.cleanupConnectionListeners_ = function() {
  ...
  this.port.onDisconnect.removeListener(this.onConnectionError_);
};
