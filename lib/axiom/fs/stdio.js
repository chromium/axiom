...
/**
 * Create a container of stdio streams, with predefined streams for stdin,
 * stdout, stderr, signal. Additional streams can be added as named properties.
 * @constructor 
 ...
 */
export var Stdio = function(stdin, stdout, stderr, signal) {
