 ...
 *
 * @param {FileSystem} domfs
 * @param {string} pathSpec
 * @param {string|OpenMode} mode
 */
export var DomOpenContext = function(domfs, pathSpec, mode) {

  OpenContext.call(this, domfs, pathSpec, mode);

  this.onFileError_ = domfsUtil.rejectFileError.bind(null, pathSpec);
...
DomOpenContext.prototype = Object.create(OpenContext);
...
DomOpenContext.prototype.seek = function(offset, whence) {
  ...
  if (start < 0) {
    return Promise.reject(new AxiomError.Runtime(
        'Invalid file offset: ' + this.pathSpec));
  }
  ...
  return new Promise(function(resolve, reject) {
    this.seek(offset, whence).then(function() {
      ...
      reader.onload = function(e) {
        ...
        var result = new ReadResult(offset, whence, dataType);
        result.data = data;
        resolve(result);
      }.bind(this);
 ...
 */
DomOpenContext.prototype.write_ = function(offset, whence, dataType, data) {
  dataType = dataType || DataType.UTF8String;
  return new Promise(function(resolve, reject) {
