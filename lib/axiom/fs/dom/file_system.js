 ...
 * @param {?} fileSystem
 */
export var DomFileSystem = function(fileSystemManager, name, fileSystem) {
  /** @type {FileSystemManager!} */
  this.fileSystemManager = fileSystemManager;
  /** @type {?} */
  this.fileSystem = fileSystem;

  FileSystem.call(this, name);
};
 ...
 */
DomFileSystem.mount = function(type, fileSystemManager, fileSystemName) {
  return new Promise(function(resolve, reject) {
    ...
    var onFileSystemFound = function(fs) {
      var domfs = new DomFileSystem(fileSystemManager, fileSystemName, fs);
 ...
 * @return {string}
 */
DomFileSystem.makeDomfsPath_ = function(path) {
...
DomFileSystem.prototype.resolve = function(path) {
  ...
  return new Promise(function(resolve, reject) {
    domfs.root.getFile(DomFileSystem.makeDomfsPath_(path), {create: true}, resolve, reject);
  });
};
...
DomFileSystem.prototype.stat = function(path) {
  ...
  return domfsUtil.getFileOrDirectory(this.fileSystem.root, DomFileSystem.makeDomfsPath_(path)).then(
      function(r) {
...
DomFileSystem.prototype.mkdir = function(path) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var onFileError = domfsUtil.rejectFileError.bind(null, path.relSpec, reject);

    this.fileSystem.root.getDirectory(DomFileSystem.makeDomfsPath_(parentPath), {create: false},
...
DomFileSystem.prototype.list = function(path) {
  ...
  return domfsUtil.listDirectory(this.fileSystem.root, DomFileSystem.makeDomfsPath_(path)).then(
    function(entries) {
