 ...
 */
export var DomFileSystem = function(fileSystemManager, name, type) {
...
/**
 * Brings this file system online.
 *
 * @override
 * @return {!Promise<undefined>} Operation completion.
 */
DomFileSystem.prototype.bringOnline = function() {
 ...
 */
DomFileSystem.prototype.getState = function() {
  // TODO(ussuri): Actually verify that the FS is still online?
