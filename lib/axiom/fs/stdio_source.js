...
export var StdioSource = function() {
  ...
  this.stdinBuffer_ = new MemoryStreamBuffer('_stdin_');
  /** @const @private @type {!MemoryStreamBuffer} */
  this.stdoutBuffer_ = new MemoryStreamBuffer('_stdout_');
  /** @const @private @type {!MemoryStreamBuffer} */
  this.stderrBuffer_ = new MemoryStreamBuffer('_stderr_');
  /** @const @private @type {!MemoryStreamBuffer} */
  this.signalBuffer_ = new MemoryStreamBuffer('_signal_');
  /** @const @private @type {!MemoryStreamBuffer} */
  this.ttyinBuffer_ = new MemoryStreamBuffer('_ttyin_');
  /** @const @private @type {!MemoryStreamBuffer} */
  this.ttyoutBuffer_ = new MemoryStreamBuffer('_ttyout_');
