...
NodeFileSystem.mount = function(fileSystemManager, fileSystemName, nodefs) {
  var fileSystem = new NodeFileSystem(fileSystemManager, fileSystemName, nodefs);
...
NodeFileSystem.prototype.list = function(path) {
  ...
  return nodefsUtil.listDirectory(this.nodefs, NodeFileSystem.makeNodefsPath_(path)).then(
    function(entries) {
