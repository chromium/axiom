...
define(
  ...
  function(axiom$core$error$$, __exports__) {
     ...
     * @return {!Object}
     */
    Arguments.prototype.toObject = function() {
      var result = {};
      for (var key in this.records) {
...
define(
  "axiom/fs/base/open_context",
  ["axiom/core/completer", "axiom/core/ephemeral", "axiom/core/error", "axiom/core/event", "axiom/fs/open_mode", "axiom/fs/path", "axiom/fs/read_result", "axiom/fs/seek_whence", "axiom/fs/write_result", "exports"],
  function(
    axiom$core$completer$$,
    axiom$core$ephemeral$$,
    axiom$core$error$$,
      ...
      return OpenContext.prototype.seek.call(this, offset, whence).then(function() {
        try {
          this.position_ = this.calcSeekPosition(
              offset, whence, this.position_, this.file_.size);
          return Promise.resolve();
        } catch (error) {
          return Promise.reject(error);
        }
...
define(
  ...
  function(
    ...
    JsFileSystem.prototype.alias = function(pathFrom, pathTo) {
      ...
      resolveTo.entry.link(targetName, resolveFrom.entry);
      return Promise.resolve();
    };
  ...
  function(
    ...
    JsOpenContext.prototype.write = function(offset, whence, dataType, data) {
      return OpenContext.prototype.write.call(this, offset, whence, dataType, data)
        ...
        return this.targetEntry.write(writeResult);
      }.bind(this));
    };
  }
);
...
define(
  "axiom/fs/nested_stdio",
  ["axiom/fs/stdio", "axiom/fs/stream/readable_stream_forwarder", "axiom/fs/stream/writable_stream_forwarder", "exports"],
  function(
    axiom$fs$stdio$$,
    axiom$fs$stream$readable_stream_forwarder$$,
    axiom$fs$stream$writable_stream_forwarder$$,
    __exports__) {
    "use strict";
    ...
    var WritableStreamForwarder;
    WritableStreamForwarder = axiom$fs$stream$writable_stream_forwarder$$["default"];
...
define(
  ...
  ["axiom/core/error", "axiom/core/event", "exports"],
  function(axiom$core$error$$, axiom$core$event$$, __exports__) {
    "use strict";
    ...
    AxiomStream.prototype.assertOpen = function() {
      if (this.closed_)
        throw new AxiomError.Runtime('Stream is closed');
    };
...
define(
  ...
  function(
    ...
    var Channel = function(name, prefixId, transport) {
      Ephemeral.call(this);
...
define(
  ...
  ["axiom/core/error", "axiom/core/event", "axiom/fs/stream/queue", "axiom/fs/stream/readable_stream_source", "axiom/fs/stream/writable_stream_source", "axiom/fs/stream/stream_buffer", "exports"],
  function(
    axiom$core$error$$,
    axiom$core$event$$,
    ...
    var StreamBuffer;
    StreamBuffer = axiom$fs$stream$stream_buffer$$["default"];
...
define(
  ...
  ["axiom/core/error", "axiom/core/event", "axiom/fs/data_type", "axiom/fs/stream/readable_stream_source", "axiom/fs/seek_whence", "axiom/fs/stream/stream_buffer", "exports"],
  function(
    axiom$core$error$$,
    axiom$core$event$$,
    axiom$fs$data_type$$,
    ...
    var ReadableFileStreamBuffer = function(
        fileSystem, filePath, dataType, openMode, opt_chunkSize) {
      StreamBuffer.call(this);
      ...
      /** @const @type {!number} */
      this.chunkSize_ = opt_chunkSize || ReadableFileStreamBuffer.CHUNK_SIZE_;
      /** @type {OpenContext} */
      this.cx_ = null;
    ...
    __es6_export__("ReadableFileStreamBuffer", ReadableFileStreamBuffer);
    __es6_export__("default", ReadableFileStreamBuffer);
...
//# sourceMappingURL=readable_file_stream_buffer.js.map
define(
...
define(
 ...
 function(
  ...
  var ReadableStreamForwarder = function(stream) {
    ...
    this.stream.onEnd.listenOnce(this.onEndCallback_, this);
    this.stream.onClose.listenOnce(this.onCloseCallback_, this);
  };
  ...
  ReadableStreamForwarder.prototype.close = function(error) {
    this.stream.onData.removeListener(this.onDataCallback_, this);
    this.stream.onReadable.removeListener(this.onReadableCallback_, this);
    AxiomStream.prototype.close.call(this, error);
  };
 }
);
...
define(
  ...
  ["axiom/core/error", "axiom/core/ephemeral", "axiom/fs/path", "axiom/fs/stream/skeleton_stdio", "axiom/fs/stream/skeleton_readable_stream", "axiom/fs/stream/skeleton_writable_stream", "exports"],
  function(
    axiom$core$error$$,
    axiom$core$ephemeral$$,
    axiom$fs$path$$,
    axiom$fs$stream$skeleton_stdio$$,
    axiom$fs$stream$skeleton_readable_stream$$,
    axiom$fs$stream$skeleton_writable_stream$$,
    __exports__) {
    "use strict";
    ...
    Path = axiom$fs$path$$["default"];
    var SkeletonStdio;
    SkeletonStdio = axiom$fs$stream$skeleton_stdio$$["default"];
    var SkeletonReadableStream;
    SkeletonReadableStream = axiom$fs$stream$skeleton_readable_stream$$["default"];
    var SkeletonWritableStream;
    SkeletonWritableStream = axiom$fs$stream$skeleton_writable_stream$$["default"];
     ...
     * @return {void}
     */
    SkeletonFileSystem.prototype.onChannelClose_ = function(subject, request) {
      if (this.isEphemeral('Ready')) {
        this.closeOk();
      }
    };
     ...
     * @return {void}
     */
    SkeletonFileSystem.prototype.onChannelRequest_ = function(subject, request) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:connect'] = function(request) {
      if (this.remoteName_) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:disconnect'] = function(request) {
      if (this.isEphemeral('Ready')) {
        this.closeOk();
      }
      return Promise.resolve();
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:alias'] = function(request) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:list'] = function(request) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:stat'] = function(request) {
      var path = this.convertPath_(request.path);
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:mkdir'] = function(request) {
      var path = this.convertPath_(request.path);
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:unlink'] = function(request) {
      var path = this.convertPath_(request.path);
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:copy'] = function(request) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:move'] = function(request) {
      var fromPath = this.convertPath_(request.fromPath);
      var toPath = this.convertPath_(request.toPath);
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:open-context.create'] =
        function(request) {
      var path = this.convertPath_(request.path);
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:open-context.open'] = function(request) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:open-context.close'] = function(request) {
      var contextId = request.contextId;
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:open-context.seek'] = function(request) {
      var contextId = request.contextId;
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:open-context.read'] = function(request) {
      var contextId = request.contextId;
      var offset = request.offset;
      var whence = request.whence;
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:open-context.write'] = function(request) {
      var contextId = request.contextId;
      var offset = request.offset;
      var whence = request.whence;
      var dataType = request.dataType;
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:execute-context.create'] =
        function(request) {
      var path = this.convertPath_(request.path);
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:execute-context.execute'] =
        function(request) {
      var contextId = request.contextId;
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:execute-context.close'] =
        function(request) {
      var contextId = request.contextId;
      var closeReason = request.closeReason;
      var closeValue = request.closeValue;
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:readable-stream.create'] =
        function(request) {
      this.nextStreamId_++;
      /** @type {!string} */
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:readable-stream.close'] =
        function(request) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:readable-stream.onData'] =
        function(request) {
      var streamId = request.streamId;
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:readable-stream.onReadable'] =
        function(request) {
      var streamId = request.streamId;
      var stream = this.readableStreams_[streamId];
      if (!stream) {
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:writable-stream.create'] =
        function(request) {
      this.nextStreamId_++;
      /** @type {!string} */
      var streamId = this.nextStreamId_.toString();
     ...
     * @return {Promise}
     */
    SkeletonFileSystem.prototype['handler:writable-stream.close'] =
        function(request) {
      var streamId = request.streamId;
      var closeReason = request.closeReason;
      var closeValue = request.closeValue;
...
define(
  "axiom/fs/stream/skeleton_readable_stream",
  ["axiom/core/ephemeral", "axiom/core/error", "axiom/core/event", "axiom/fs/stream/axiom_stream", "axiom/fs/stream/memory_stream_buffer", "exports"],
  function(
    axiom$core$ephemeral$$,
    axiom$core$error$$,
    axiom$core$event$$,
    ...
    __es6_export__("default", SkeletonReadableStream);
...
//# sourceMappingURL=skeleton_readable_stream.js.map
define(
  "axiom/fs/stream/skeleton_stdio",
  ["axiom/core/ephemeral", "axiom/fs/stdio", "exports"],
  function(axiom$core$ephemeral$$, axiom$fs$stdio$$, __exports__) {
    "use strict";
    ...
    __es6_export__("default", SkeletonStdio);
...
//# sourceMappingURL=skeleton_stdio.js.map
define(
  "axiom/fs/stream/skeleton_writable_stream",
  ["axiom/core/ephemeral", "axiom/core/error", "axiom/fs/stream/axiom_stream", "exports"],
  function(
    axiom$core$ephemeral$$,
    axiom$core$error$$,
    axiom$fs$stream$axiom_stream$$,
    ...
    __es6_export__("default", SkeletonWritableStream);
    ...
    WritableStreamImplementation.prototype.end = function() {
      ...
      throw new AxiomError.NotImplemented('Not implemented yet');
    };
  }
);

//# sourceMappingURL=skeleton_writable_stream.js.map
define(
  "axiom/fs/stream/stream_buffer",
  ["axiom/core/error", "axiom/core/event", "axiom/fs/stream/queue", "exports"],
  function(
    axiom$core$error$$,
    axiom$core$event$$,
    axiom$fs$stream$queue$$,
    ...
    __es6_export__("StreamBuffer", StreamBuffer);
    __es6_export__("default", StreamBuffer);
...
define(
  "axiom/fs/stream/stub_execute_context",
  ["axiom/fs/base/execute_context", "axiom/fs/stdio", "axiom/fs/path", "axiom/fs/js/executable", "exports"],
  function(
    axiom$fs$base$execute_context$$,
    axiom$fs$stdio$$,
    ...
    __es6_export__("StubExecuteContext", StubExecuteContext);
    __es6_export__("default", StubExecuteContext);
...
//# sourceMappingURL=stub_execute_context.js.map
define(
  "axiom/fs/stream/stub_file_system",
  ["axiom/core/error", "axiom/fs/base/file_system", "axiom/fs/stream/stub_open_context", "axiom/fs/stream/stub_execute_context", "axiom/fs/arguments", "axiom/fs/stream/axiom_stream", "axiom/fs/stream/stub_stdio", "axiom/fs/stream/stub_readable_stream", "axiom/fs/stream/stub_writable_stream", "exports"],
  function(
    axiom$core$error$$,
    axiom$fs$base$file_system$$,
    axiom$fs$stream$stub_open_context$$,
    axiom$fs$stream$stub_execute_context$$,
    axiom$fs$arguments$$,
    axiom$fs$stream$axiom_stream$$,
    axiom$fs$stream$stub_stdio$$,
    axiom$fs$stream$stub_readable_stream$$,
    axiom$fs$stream$stub_writable_stream$$,
    __exports__) {
    "use strict";
    ...
    FileSystem = axiom$fs$base$file_system$$["default"];
    var StubOpenContext;
    StubOpenContext = axiom$fs$stream$stub_open_context$$["default"];
    var StubExecuteContext;
    StubExecuteContext = axiom$fs$stream$stub_execute_context$$["default"];
    var Arguments;
    Arguments = axiom$fs$arguments$$["default"];
    var AxiomStream;
    AxiomStream = axiom$fs$stream$axiom_stream$$["default"];
    var StubStdio;
    StubStdio = axiom$fs$stream$stub_stdio$$["default"];
    var StubReadableStream;
    StubReadableStream = axiom$fs$stream$stub_readable_stream$$["default"];
    var StubWritableStream;
    StubWritableStream = axiom$fs$stream$stub_writable_stream$$["default"];
...
define(
  ...
  function(
    ...
    var StubOpenContext = function(fileSystem, path, mode, contextId) {
    ...
    __es6_export__("StubOpenContext", StubOpenContext);
    __es6_export__("default", StubOpenContext);
     ...
     * @return {void}
     */
    StubOpenContext.prototype.onClose_ = function(closeReason, closeValue) {
      this.fileSystem.sendRequest_({
...
//# sourceMappingURL=stub_open_context.js.map
define(
  "axiom/fs/stream/stub_readable_stream",
  ["axiom/core/ephemeral", "axiom/core/error", "exports"],
  function(axiom$core$ephemeral$$, axiom$core$error$$, __exports__) {
    "use strict";
    ...
    __es6_export__("default", StubReadableStream);
...
//# sourceMappingURL=stub_readable_stream.js.map
define(
 "axiom/fs/stream/stub_stdio",
 ["axiom/core/ephemeral", "axiom/fs/stdio", "exports"],
 function(axiom$core$ephemeral$$, axiom$fs$stdio$$, __exports__) {
  ...
  __es6_export__("default", StubStdio);

  StubStdio.prototype = Object.create(Ephemeral.prototype);

  /**
   * Return an dictionary of stream name to remote stream id
   *
  ...
  StubStdio.prototype.getStdio = function() {
    // Note: The local Stdio instance should not be used for anything, as the
    // corresponding local execute context and streams forward all events and
    // function calls to their remote counter parts.
    return this.parentStdio_;
  };
 }
);

//# sourceMappingURL=stub_stdio.js.map
define(
  "axiom/fs/stream/stub_writable_stream",
  ["axiom/core/ephemeral", "axiom/core/error", "exports"],
  function(axiom$core$ephemeral$$, axiom$core$error$$, __exports__) {
    ...
    __es6_export__("default", StubWritableStream);
...
//# sourceMappingURL=stub_writable_stream.js.map
define(
...
define(
  ...
  function(
     ...
     * @return {void}
     */
    WebSocketStreams.prototype.flush = function() {
      this.flushWriteQueue_();
      this.flushReadQueue_();
    };
...
define(
  ...
  ["axiom/core/error", "axiom/core/event", "axiom/fs/data_type", "axiom/fs/seek_whence", "axiom/fs/stream/stream_buffer", "axiom/fs/stream/writable_stream_source", "exports"],
  function(
    axiom$core$error$$,
    axiom$core$event$$,
    axiom$fs$data_type$$,
    ...
    var WritableFileStreamBuffer = function(
    ...
    __es6_export__("WritableFileStreamBuffer", WritableFileStreamBuffer);
    __es6_export__("default", WritableFileStreamBuffer);
...
//# sourceMappingURL=writable_file_stream_buffer.js.map
define(
 "axiom/fs/stream/writable_stream",
 ["axiom/core/event", "exports"],
 function(axiom$core$event$$, __exports__) {
  "use strict";
  ...
  __es6_export__("WriteCallback", WriteCallback);
...
define(
 "axiom/fs/stream/writable_stream_forwarder",
 ["axiom/core/error", "axiom/core/event", "axiom/core/completer", "axiom/fs/stream/axiom_stream", "exports"],
 function(
  axiom$core$error$$,
  axiom$core$event$$,
  axiom$core$completer$$,
  ...
  var WritableStreamForwarder = function(stream) {
    AxiomStream.call(this);
  ...
  __es6_export__("WritableStreamForwarder", WritableStreamForwarder);
  __es6_export__("default", WritableStreamForwarder);
...
//# sourceMappingURL=writable_stream_forwarder.js.map
define(
 "axiom/fs/stream/writable_stream_source",
 ["axiom/core/error", "axiom/core/event", "axiom/core/completer", "axiom/fs/stream/axiom_stream", "exports"],
 function(
...
define(
    "axiom/fs/write_result",
    ["axiom/fs/data_type", "exports"],
    function(axiom$fs$data_type$$, __exports__) {
        "use strict";
        ...
        var WriteResult = function(offset, whence, dataType, data) {
          /** @type {number} */
          this.offset = offset;
